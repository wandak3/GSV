...
module.exports = {
    ...
    async execute(message, client, Client) {
        ...
        if(moderator === true) {
            if (!message.member.roles.cache.has("912330014702313492") && !message.member.roles.cache.has("805707274530062356") && !message.member.roles.cache.has("1035041217756545064") && message.author.id != "291345472327516170") {
                return;
            }
        }
